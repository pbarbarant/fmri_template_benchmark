...
def get_results_dataframe(
    ...
    # df = df[
    #     ~((df["solver_name"] == "Anatomical") & (df["target"] == "pairwise"))
    # ]
...
df = get_results_dataframe(data_path, score="time", n_parcels=N_PARCELS)
...
def create_accuracy_plot(data, figsize=(12, 7)):
    ...
    shifted_palette = original_palette[2:]
    sns.barplot(
        data=data,
        x="time",
        y="data_name",
...
fig = create_accuracy_plot(task_data, figsize=(3.15, 8))
